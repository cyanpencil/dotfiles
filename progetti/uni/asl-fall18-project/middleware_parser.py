...
# keywords2 = ['throughput', 'resp_time', 'mainthread', 'queue_size', 'queue_time', 'waiting', 'calculating']
...
def prova(ciao):
    keyword = 'set'
    return np.mean([np.mean(data[keyword][32][64][rep][ciao]) for rep in data[keyword][32][64]])

# print("Worker thread service time: ", prova('calculating'))
# print("Net thread service time: ", prova('mainthread'))

# print("Net thread service time: ", 14.8844 - 1.0 - (prova('resp_time') + prova('mainthread')))
# print(prova('mainthread'))

# print(prova('resp_time'))
