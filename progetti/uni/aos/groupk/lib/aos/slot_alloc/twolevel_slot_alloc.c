...
static errval_t alloc(struct slot_allocator *ca, struct capref *ret, bool should_refill)
{
...
errval_t two_level_alloc_no_refill(struct slot_allocator *ca, struct capref *ret) {
    return alloc(ca, ret, false);
}
