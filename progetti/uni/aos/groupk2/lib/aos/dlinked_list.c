...
dlinked_node_t* dlist_head(dlinked_list_t* list) { return list->head; }

dlinked_node_t* dlist_tail(dlinked_list_t* list) { return list->tail; }
...
void dlist_remove_node(dlinked_list_t* list, void* _node) {
    assert(_node != NULL);
    dlinked_node_t* node = (dlinked_node_t*) _node;
