...
--
-- For example, if we are building for architecture 'armv7', with build tree
-- '/home/user/aos/build' and build tree '/home/user/aos'
...
--
--   In SourceTree "../apps/init" "armv7" "main.c"
--      -> "../apps/init/main.c"
--   In BuildTree "../apps/init" "armv7" "/include/generated.h"
