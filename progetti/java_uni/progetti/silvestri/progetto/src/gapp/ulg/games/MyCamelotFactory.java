 ...
 */
public class MyCamelotFactory implements GameFactory<GameRuler<PieceModel<Species>>> {
    @Override
    public String name() {
        return "MyCamelot";
    }
    ...
    Param<String> timeParam = new Param<String>() {
        ...
        public String prompt() {
            return "Time limit for a Camelot move";
        }
    ...
    public GameRuler<PieceModel<Species>> newGame() {
        ...
        return new MyCamelot(time, playerNames.get(0), playerNames.get(1));
    }
