...
static class nit> extends nit>
{
            ...
            {
/* 523*/        return new <init>(nit>.renceQueue, obj, i, nit>1);
            }

            final renceQueue copyEntry(renceQueue rencequeue, renceQueue rencequeue1, renceQueue rencequeue2)
            {
/* 529*/        rencequeue = super.pyEntry(rencequeue, rencequeue1, rencequeue2);
/* 530*/        copyWriteEntry(rencequeue1, rencequeue);
/* 531*/        return rencequeue;
            }
