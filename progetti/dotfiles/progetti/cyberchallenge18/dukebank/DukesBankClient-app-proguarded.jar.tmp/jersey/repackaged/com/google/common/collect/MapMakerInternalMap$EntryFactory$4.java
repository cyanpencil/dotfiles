...
static class nit> extends nit>
{
            ...
            {
/* 393*/        return new EvictableEntry(obj, i, nit>1);
            }

            final EvictableEntry copyEntry(EvictableEntry evictableentry, EvictableEntry evictableentry1, EvictableEntry evictableentry2)
            {
/* 399*/        evictableentry = super.pyEntry(evictableentry, evictableentry1, evictableentry2);
/* 400*/        copyExpirableEntry(evictableentry1, evictableentry);
/* 401*/        copyEvictableEntry(evictableentry1, evictableentry);
/* 402*/        return evictableentry;
            }
