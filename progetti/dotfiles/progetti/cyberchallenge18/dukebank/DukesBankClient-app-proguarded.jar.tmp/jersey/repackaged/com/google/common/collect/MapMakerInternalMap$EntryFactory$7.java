...
static class nit> extends nit>
{
            ...
            {
/* 432*/        return new try(nit>.renceQueue, obj, i, nit>1);
            }

            final renceQueue copyEntry(renceQueue rencequeue, renceQueue rencequeue1, renceQueue rencequeue2)
            {
/* 438*/        rencequeue = super.pyEntry(rencequeue, rencequeue1, rencequeue2);
/* 439*/        copyEvictableEntry(rencequeue1, rencequeue);
/* 440*/        return rencequeue;
            }
