...
/*  67*/            return ((BeanDescriptor) (obj));
                ...
                public CompositeBeanDescriptorProvider(List list)
                {
/*  47*/            providers = new ArrayList(list);
    ...
    public abstract BeanDescriptor provide(Class class1, Genson genson);

    public abstract BeanDescriptor provide(Class class1, Type type, Genson genson);
}
