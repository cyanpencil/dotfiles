...
static class nit> extends nit>
{
            ...
            {
/* 538*/        return new Entry(nit>.renceQueue, obj, i, nit>1);
            }

            final renceQueue copyEntry(renceQueue rencequeue, renceQueue rencequeue1, renceQueue rencequeue2)
            {
/* 544*/        rencequeue = super.pyEntry(rencequeue, rencequeue1, rencequeue2);
/* 545*/        copyAccessEntry(rencequeue1, rencequeue);
/* 546*/        copyWriteEntry(rencequeue1, rencequeue);
/* 547*/        return rencequeue;
            }
