...
\begin{tabular}{ll}
	%2019 \mH & \mh \textbf{Master Thesis}: My thesis involves adding support for the ARM architecture to \href{https://hexhive.epfl.ch/publications/files/20Oakland.pdf}{Retrowrite}, a binary \\ & rewriter  that adds memory sanitization and coverage tracing to closed source binaries, with the goal \\ & of fuzzing proprietary Android kernel modules\\
