...
/* 209*/            input = new DataInputStream(bytearrayinputstream);
            ...
            {
/* 177*/        return newDataInput(new ByteArrayInputStream(abyte0));
            }

            public static ByteArrayDataInput newDataInput(byte abyte0[], int i)
            {
/* 188*/        Preconditions.checkPositionIndex(i, abyte0.length);
/* 189*/        return newDataInput(new ByteArrayInputStream(abyte0, i, abyte0.length - i));
            }
