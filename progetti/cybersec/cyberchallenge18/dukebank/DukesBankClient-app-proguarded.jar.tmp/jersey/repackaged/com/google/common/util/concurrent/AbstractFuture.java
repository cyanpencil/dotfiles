...
/* 386*/            return flag;
            ...
            {
/*  96*/        return sync.get(timeunit.toNanos(l));
            }
...
/* 160*/        return sync.wasInterrupted();
            ...
            {
/* 170*/        executionList.add(runnable, executor);
            }

            protected boolean set(Object obj)
            {
/* 183*/        if((obj = sync.set(obj)) != 0)
...
/* 187*/        return ((boolean) (obj));
            ...
            {
/* 200*/        if((throwable = sync.setException((Throwable)Preconditions.checkNotNull(throwable))) != 0)
...
/* 204*/        return throwable;
            ...
            {
/* 392*/        (s = new CancellationException(s)).initCause(throwable);
/* 394*/        return s;
            }
